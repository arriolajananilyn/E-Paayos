...
function IndependentMechanicMessages() {
  ...
  const independentHeaderUnread = independentEventUnread ?? independentNotifUnread
...
export default IndependentMechanicMessages
