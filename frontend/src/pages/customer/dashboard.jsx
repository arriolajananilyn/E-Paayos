...
import { Bell, Calendar, LogOut, Settings, Star, User, Wrench } from 'lucide-react'
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Your home for booking and managing vehicle services.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card className="shadow-md border-gray-200/80 opacity-90">
            <CardHeader className="pb-2">
              <div className="h-9 w-9 rounded-lg bg-purple-100 text-purple-700 flex items-center justify-center mb-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                You&apos;ll be able to find mechanics and request repairs here.
              </p>
            </CardContent>
          </Card>

          <Card className="shadow-md border-gray-200/80 opacity-90 sm:col-span-2 lg:col-span-1">
            <CardHeader className="pb-2">
              <div className="h-9 w-9 rounded-lg bg-emerald-100 text-emerald-700 flex items-center justify-center mb-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Track active and past appointments in one place.
              </p>
            </CardContent>
          </Card>
        </div>
