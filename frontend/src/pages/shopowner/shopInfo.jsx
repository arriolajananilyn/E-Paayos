...
function ShopInfoLayout({ variant, pageMeta, children }) {
  if (variant === 'independent') {
    return (
      <OnCallMechanicLayout activeSection="business-info" pageMeta={pageMeta} wrapContent={false}>
...
export function ShopInfoInner({ variant = 'shop' }) {
  ...
  if (profileLoading) {
    return (
      ...
      >
        <div className="flex min-h-[180px] sm:min-h-[200px] items-center justify-center rounded-none border border-border/60 bg-card/80 p-4 sm:p-8">
  ...
  if (loadError) {
    return (
      ...
      >
        <Card className="rounded-none border-destructive/40 shadow-sm p-4 sm:p-6">
          <CardHeader className="p-0 pb-3">
            <CardTitle className="text-sm sm:text-base text-destructive">Could not load</CardTitle>
            <CardDescription className="text-xs">{loadError}</CardDescription>
          </CardHeader>
          <CardContent className="p-0 pt-2">
            <Button type="button" variant="outline" onClick={() => window.location.reload()} className="w-full sm:w-auto text-xs">
              Reload page
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    ...
    >
      <div className="grid gap-3 sm:gap-3.5 lg:grid-cols-[1fr_min(380px,100%)] min-w-0 w-full">
        <div className="space-y-3 sm:space-y-3.5 min-w-0">
          ...
          <Card className="rounded-none border border-slate-200 bg-white p-0 shadow-[0_3px_8px_rgba(15,23,42,0.14)] hover:shadow-[0_6px_16px_rgba(8,31,92,0.22)] hover:border-[#081F5C] transition-all">
            <CardHeader className="border-b border-slate-100 bg-slate-50/80 p-3 sm:p-3.5">
              <div className="flex items-start gap-2.5">
                <div className="flex size-8 sm:size-9 shrink-0 items-center justify-center rounded-none bg-indigo-50/80 border border-indigo-200/80 text-[#081F5C] shadow-2xs">
                  <Camera className="size-4 sm:size-4.5" />
                </div>
                <div className="min-w-0 space-y-0.5">
                  <CardTitle className="text-xs sm:text-sm font-black tracking-tight text-slate-900">
                    {isOnCallProvider ? 'Business Place Photo' : 'Shop Photo'}
                  </CardTitle>
                  <CardDescription className="text-[11px] sm:text-xs font-medium text-slate-500 leading-snug">
                    {isOnCallProvider
            ...
            <CardContent className="space-y-2.5 sm:space-y-3 p-3 sm:p-3.5">
              <div className="relative w-full">
                ...
                >
                  {shopPhotoDisplayUrl ? (
                    ...
                    <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-2 sm:gap-2.5 p-4 sm:p-6 text-center">
                      <div className="flex size-10 sm:size-12 items-center justify-center rounded-none bg-indigo-50/80 border border-indigo-200/80 text-[#081F5C] shadow-2xs transition-transform group-hover:scale-105">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="max-w-xs text-[10px] sm:text-[11px] text-slate-500">
                ...
                {form.shopPlacePhoto ? (
                  <button
                    ...
                    className="absolute right-2 sm:right-2.5 top-2 sm:top-2.5 z-20 flex size-8 items-center justify-center rounded-none border border-slate-300 bg-white/95 text-slate-700 shadow-md hover:bg-rose-50 hover:text-rose-600 cursor-pointer"
          ...
          <Card className="rounded-none border border-slate-200 bg-white p-0 shadow-[0_3px_8px_rgba(15,23,42,0.14)] hover:shadow-[0_6px_16px_rgba(8,31,92,0.22)] hover:border-[#081F5C] transition-all">
            <CardHeader className="border-b border-slate-100 bg-slate-50/80 p-3 sm:p-3.5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <CardTitle className="text-xs sm:text-sm font-black text-slate-900">
            ...
            <CardContent className="space-y-3 p-3 sm:p-3.5">
              <div className="grid gap-1">
                <Label htmlFor="shopName" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
              ...
              <div className="grid gap-1">
                <Label className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
              ...
              <div className={`grid gap-2.5 sm:gap-3 ${isOnCallProvider ? '' : 'sm:grid-cols-2'}`}>
                <div className="grid gap-1">
                  <Label htmlFor="yearsOfOperation" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
                ...
                {!isOnCallProvider ? (
                  <div className="grid gap-1">
                    <Label htmlFor="numberOfEmployees" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
              ...
              <div className="bg-slate-50/80 p-2.5 sm:p-3 border border-slate-200 rounded-none space-y-1.5">
                <Label htmlFor="operatingHoursOpenHH" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-800 block">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-1">
                          <Input
                            ...
                            className="h-8 w-12 sm:w-14 text-center rounded-none border-slate-300 font-bold text-xs"
                          />
              ...
              <div className="grid gap-1">
                <Label htmlFor="shopDescription" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
                ...
                <Textarea
                  ...
                  rows={3}
                  className="rounded-none border-slate-300 text-xs font-medium min-h-[70px] sm:min-h-[80px] resize-y shadow-2xs focus:border-[#081F5C]"
          ...
          <Card className="rounded-none border border-slate-200 bg-white p-0 shadow-[0_3px_8px_rgba(15,23,42,0.14)] hover:shadow-[0_6px_16px_rgba(8,31,92,0.22)] hover:border-[#081F5C] transition-all">
            <CardHeader className="border-b border-slate-100 bg-slate-50/80 p-3 sm:p-3.5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <CardTitle className="text-xs sm:text-sm font-black text-slate-900">Shop Location & Address</CardTitle>
                  <CardDescription className="text-[11px] sm:text-xs font-medium text-slate-500 leading-snug">
            ...
            <CardContent className="space-y-3 p-3 sm:p-3.5 min-w-0">
              ...
              <div className="grid gap-1">
                <Label htmlFor="shopDetailedAddress" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
              ...
              <div className="grid gap-1">
                <Label htmlFor="shopLandmark" className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-700">
          ...
          <Card className="rounded-none border border-slate-200 bg-slate-50/80 p-3 sm:p-3.5 shadow-2xs">
            <CardHeader className="p-0 pb-2 border-b border-slate-200">
              <CardTitle className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-wider text-slate-800">
            ...
            <CardContent className="p-0 pt-2 grid gap-1.5 text-xs sm:grid-cols-2">
              <div>
                ...
                <span className="font-bold text-slate-900 break-words">{account.fullName || '—'}</span>
              </div>
              <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-2.5 pt-1">
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              <Button
                type="button"
                onClick={handleSave}
                disabled={saving || !isDirty}
                className="w-full sm:w-auto h-10 sm:h-9 justify-center rounded-none bg-linear-to-r from-[#04133d] to-[#081F5C] hover:opacity-95 text-white font-bold text-xs px-4 shadow-md shadow-[#081F5C]/25 cursor-pointer disabled:opacity-50 transition-all"
              >
              ...
              <Button
                ...
                className="w-full sm:w-auto h-10 sm:h-9 justify-center rounded-none border-slate-300 text-slate-700 font-bold text-xs px-3.5 cursor-pointer disabled:opacity-50"
              >
                <RotateCcw className="mr-1.5 size-3.5" />
                Revert Changes
              </Button>
            </div>
            {saveNotice ? <span className="w-full sm:w-auto text-center sm:text-left text-xs font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1.5 sm:py-1 border border-emerald-200 rounded-none">{saveNotice}</span> : null}
            {saveError ? <span className="w-full sm:w-auto text-center sm:text-left text-xs font-bold text-rose-600 bg-rose-50 px-2.5 py-1.5 sm:py-1 border border-rose-200 rounded-none">{saveError}</span> : null}
          </div>
        </div>

        {/* Customer Preview Sidebar */}
        <div className="lg:sticky lg:top-4 lg:self-start min-w-0 w-full">
          <Card className="rounded-none border border-slate-200 bg-white p-0 shadow-[0_3px_8px_rgba(15,23,42,0.14)] hover:shadow-[0_6px_16px_rgba(8,31,92,0.22)] hover:border-[#081F5C] transition-all">
            <CardHeader className="border-b border-slate-100 bg-slate-50/80 p-3 sm:p-3.5">
            ...
            <CardContent className="p-3 sm:p-3.5">
              <div className="rounded-none bg-linear-to-r from-[#04133d] via-slate-900 to-[#081F5C] p-3 sm:p-3.5 text-white shadow-md space-y-2.5 min-w-0">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <div className="flex size-11 sm:size-12 shrink-0 items-center justify-center overflow-hidden rounded-none border border-white/30 bg-white/10">
                    {shopPhotoDisplayUrl ? (
                      <img
                        src={shopPhotoDisplayUrl}
                        alt=""
                      ...
                      <Store className="size-5 sm:size-6 text-white" aria-hidden />
                    )}
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="text-xs sm:text-sm font-black leading-snug truncate">
                      {isOnCallProvider
                        ? account.fullName || 'Provider'
                        : form.shopName.trim() || 'Shop name'}
                    </div>
                    <div className="text-[10px] sm:text-[11px] text-indigo-200 font-medium mt-0.5 truncate">
                      {isOnCallProvider ? 'On-call provider' : `Owner: ${account.fullName || '—'}`}
                    </div>
                    <div className="mt-1.5 sm:mt-2 flex items-center gap-1.5 text-[11px] sm:text-xs text-white/90">
                      <MapPin className="size-3.5 shrink-0 text-rose-400" />
                      <span className="truncate">{previewAddressLine}</span>
                    </div>
                    {form.shopLandmark?.trim() ? (
                      <p className="mt-1 text-[10px] sm:text-[11px] text-slate-300 truncate">Landmark: {form.shopLandmark}</p>
                    ) : null}
                  </div>
                </div>

                <div className="space-y-2 border-t border-white/15 pt-3 text-[10px] sm:text-[11px] text-slate-200">
              ...
              <p className="mt-2.5 sm:mt-3 text-[10px] sm:text-[11px] text-slate-500 leading-relaxed text-center">
