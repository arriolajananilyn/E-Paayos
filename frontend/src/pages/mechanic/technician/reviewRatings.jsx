            ...
            >
              <Card className="border-border/80 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>Sample rating summary until live review data is available.</CardDescription>
                </CardHeader>
                <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="rounded-lg border border-border/80 p-3">
                    <p className="text-xs uppercase text-muted-foreground">Average Rating</p>
                    <p className="mt-1 text-sm font-medium text-foreground">4.8 / 5.0</p>
                  </div>
                  <div className="rounded-lg border border-border/80 p-3">
                    <p className="text-xs uppercase text-muted-foreground">Total Reviews</p>
                    <p className="mt-1 text-sm font-medium text-foreground">126</p>
                  </div>
                  <div className="rounded-lg border border-border/80 p-3">
                    <p className="text-xs uppercase text-muted-foreground">5-Star Reviews</p>
                    <p className="mt-1 text-sm font-medium text-foreground">98</p>
                  </div>
                </CardContent>
              </Card>
            </div>
