          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filtered.map((b) => {
                ...
                return (
                  <article key={b.id} className="bg-white border border-slate-200 shadow-[0_3px_8px_rgba(15,23,42,0.12)] transition-all duration-200 hover:border-indigo-500 hover:shadow-[0_6px_16px_rgba(8,31,92,0.18)] hover:-translate-y-0.5 p-4 sm:p-5 space-y-4 rounded-none">
                    {/* Top Bar Header */}
                          ...
                          <div className="flex items-center justify-between pb-1">
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                onClick={() => {
                                  try {
                                    if (b.customer?.id) sessionStorage.setItem('epaayosActiveChatCustomerId', b.customer.id)
                                  } catch {}
                                  window.location.hash = '#/independent/technician/messages'
                                }}
                                className="inline-flex items-center gap-1 px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 text-xs font-bold rounded-none shadow-2xs transition-colors cursor-pointer"
                              >
