...
export function OnCallMechanicServiceHistory() {
  ...
  useEffect(() => {
    ...
    try {
      const id = sessionStorage.getItem(FOCUS_KEY) || sessionStorage.getItem('epaayosIndependentHistoryFocusBookingId')
      if (id) {
        setHighlightId(id)
        sessionStorage.removeItem(FOCUS_KEY)
        sessionStorage.removeItem('epaayosIndependentHistoryFocusBookingId')
